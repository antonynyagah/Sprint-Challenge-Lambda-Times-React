...
HOCs are functions that take in a component as an argument and returns it as a new component, in others words we can use them to create a new component with added features implemented to the start component, in which we can then use to encapsulate other components that share functionality
